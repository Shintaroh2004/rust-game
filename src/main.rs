...
fn main() {
    ...
    let material = rend3_routine::pbr::PbrMaterial {
        albedo: rend3_routine::pbr::AlbedoComponent::Value(glam::Vec4::new(0.3, 0.6, 0.9, 1.0)),
            ...
            winit::event::Event::WindowEvent {
                ...
                base_rendergraph.add_to_graph(
                    ...
                    rend3_routine::base::BaseRenderGraphSettings {
                        ...
                        clear_color: glam::Vec4::new(0.10, 0.15, 0.30, 1.0), // Nice scene-referred purple
                    },
                );
